...
| Fase preparatória | Piloto de viabilidade Petstore | Ambiente, códigos, autenticação, persistência, limpeza, filtro e divergências | [`Piloto_de_Viabilidade.md`](Piloto_de_Viabilidade.md), [`Relatorio_do_Piloto_de_Viabilidade.md`](Relatorio_do_Piloto_de_Viabilidade.md) | Concluído; ambiente controlado recomendado |
